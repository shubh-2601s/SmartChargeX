...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://smart-charge-x.vercel.app",  # previous domain (if still used)
        "https://smartchargex.onrender.com",  # alternate frontend
        "https://smart-charge-erpgnyyzm-shubh-2601s-projects.vercel.app",  # ✅ new Vercel deployment
    ],
    allow_methods=["*"],
    allow_headers=["*"],
)
